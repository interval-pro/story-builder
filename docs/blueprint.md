...
> и разходът се мери в токени, не в пари. След това `docs/plan-local-layer.md`
> махна worktrees, Docker sandbox-а и docker-compose: стори работи в папката на
> проекта на свой бранч, нищо не се пише в добавен проект, и всичко живее в базата.
> Където този документ и README си противоречат, README е верният.
